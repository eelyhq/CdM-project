...
# GENERATE ENEMY'S SHIPS----------------    
    ...
    loop: 
        # if r3 == 0: break
        tst r3
        bz exit # end generate (break)
        # ---
        jsr rand # generate current ship
    ...
    vertical:
        ...
        check_vert:
            ...
            bgt loop # if Y_end > 10: generate again  
        ...
        # check the first square (X, Y) 
            ...
            tst r0
            bnz loop # if this square is not free: generate again
        #-----------
        ...
        place:
            ...
            inc r1 
            inc r1
            br loop # go to generate next ship
    ...
    horizontal:
        ...
        #-----
            ...
            tst r0 
            bnz loop # if can not replace generate again
            #-------------------------------- 
