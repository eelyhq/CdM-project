...
draw>
    ...
    ldi r5, 0xffc2
    stb r5, r5     # Clear the screen

    # 1. Save Player 1 choice
    ldi r0, p1_choice
    stw r0, r1

    # 2. Generate Bot choice (Random from 0xff82)
    ldi r0, 0xff82
    ldw r0, r1
    
    # Fast Modulo 3 implementation for CdM-16
    ldi r2, 0xff   # Mask to lower 8 bits (0-255) for speed
    and r1, r2, r1
mod_loop:
    ldi r2, 3
    cmp r1, r2
...
print_bot_word:
    ...
    end_draw:
    # The winner is stored in 'first_shooter'. Time to exit draw routine.
    ldi r5, 0xffc0
    ldi r6, 10
    stw r5, r6
    rts 
