...
beg:
         ...
         # Возвращаемся туда, откуда вызвали эту функцию
...
# ldi r1, 0xff6a   # Указатель на начало поля в памяти (откуда читаем)
...
check_up_fire:
    ...
    shl r7, r7, 3   # Сдвиг для матрицы ff00
...
check_right_fire:
    ...
    shl r7, r7, 3   # Сдвиг на 3 для экрана ff00
    stw r4, r7      # Рисуем
    br check_button_fire
...
check_fire:
    ...
    shl r4, r4, 2     # Сдвигаем ВСЮ СТРОКУ на 2 влево для матрицы ff14
...
shl r3, r3, 3   # Сдвиг для матрицы ff56
...
pop r6
bne skip_hor_sh1
shl r2, r2, 2  # Сдвигаем на 2 если это матрица бота (ff40)
skip_hor_sh1:
